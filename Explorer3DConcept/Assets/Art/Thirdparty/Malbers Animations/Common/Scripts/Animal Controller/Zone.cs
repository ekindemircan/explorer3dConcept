            ...
            EditorGUILayout.BeginVertical(MalbersEditor.StyleGray);
            {
                ...
                switch (zone)
                {
                    ...
                    case ZoneType.State:
                      ...
                      if (stateaction == (int)StateAction.ChangeStatus)  EditorGUILayout.PropertyField(stateStatus, new GUIContent("Status", "Set the State Status"));
