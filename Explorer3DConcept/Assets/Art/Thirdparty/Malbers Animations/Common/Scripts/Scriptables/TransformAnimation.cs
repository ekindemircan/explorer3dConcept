...
namespace MalbersAnimations
{
  //  public enum AnimCycle { None, Loop, Repeat, PingPong }
    ...
    public class TransformAnimation : ScriptableObject
    {
        ...
        public void Play(MonoBehaviour coroutine)
        {
            if (coroutine.isActiveAndEnabled)
            coroutine.StartCoroutine(PlayTransformAnimation(coroutine.transform));
        }

        public void PlayForever(MonoBehaviour coroutine)
        {
            if (coroutine.isActiveAndEnabled)
            coroutine.StartCoroutine(PlayTransformAnimationForever(coroutine.transform));
        }
