...
namespace BeautifyEffect {
    ...
    public class Beautify : MonoBehaviour {
        ...
        const string BEAUTIFY_BUILD_HINT = "BeautifyBuildHint79RC2";
        ...
        public void UpdateMaterialPropertiesNow() {
            ...
            bMat.SetVector("_HardLight", new Vector3(_hardLightBlend, _hardLightIntensity));
            ...
            bMat.SetVector("_FXData", new Vector4(_vignettingCenter.x, vignettingCenterY, _sharpenMinMaxDepthFallOff));
            ...
            if (_quality != BEAUTIFY_QUALITY.Basic) {
                ...
                if (_bloom || _anamorphicFlares || _sunFlares) {
                    ...
                    if (_bloomDepthAtten > 0 || _bloomNearAtten > 0) {
                        bMat.SetFloat("_BloomDepthThreshold", _bloomDepthAtten);
                        bMat.SetFloat("_BloomNearThreshold", _bloomNearAtten);
                ...
                if (_eyeAdaptation) {
                    ...
                    if (!Application.isPlaying && !_eyeAdaptationInEditor) {
                        bMat.SetTexture("_EALumSrc", Texture2D.whiteTexture);
                        bMat.SetTexture("_EAHist", Texture2D.whiteTexture);
                    }
#endif
                }
                if (_quality == BEAUTIFY_QUALITY.BestQuality) {
